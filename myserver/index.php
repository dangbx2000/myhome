...
<body>
	<div class="main" id="main">
		...
		<div class="footer5" id="footer5">
			...
			<div class="doorctrl">
					<h4>Gate:</h4>
					<button id="unlockbtn1" onclick="getdata('onGate')"><img src="image/unlock-icon.png" id="unlock1"></button>
					<button id="lockbtn1" onclick="getdata('offGate')"><img src="image/lock-icon.png" id="lock1"></button>
					<h4>Door:</h4>
					<button id="unlockbtn2" onclick="getdata('onDoor')"><img src="image/unlock-icon.png" id="unlock2"></button>
					<button id="lockbtn2" onclick="getdata('offDoor')"><img src="image/lock-icon.png" id="lock2"></button>
					<h4>Window:</h4>
					<button id="unlockbtn3" onclick="getdata('onWindow')"><img src="image/unlock-icon.png" id="unlock3"></button>
					<button id="lockbtn3" onclick="getdata('offWindow')"><img src="image/lock-icon.png" id="lock3"></button>
			</div>
			<div class="statusdoor">
				<h4>Status</h4>
				<div id="trangthai_gate">
					<img src="image/gateclose1.png" id="gateclosestatus">
					<img src="image/gateopen1.png" id="gateopenstatus">
				</div>
				<br><div id="clearf"></div>
				<div id="trangthai_Door">
					<img src="image/doorclose1.png" id="doorclosestatus">
					<img src="image/dooropen1.png" id="dooropenstatus">
				</div>
				<br><div id="clearf"></div>
				<div id="trangthai_Window">
